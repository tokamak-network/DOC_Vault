...
async function main() {
  ...
  console.log("LPStakingVault Address:", vaultContract.address);
  ...
  const tgeAmount = 4629630               //46,296.30
  ...
  const firstClaimAmount = 134259259      //1,342,592.59
  ...
  //전송 후 DOC 토큰 전송 필요
  //npx hardhat verify --contract contracts/LPStakingVault.sol:LPStakingVault a b --network rinkeby
}
