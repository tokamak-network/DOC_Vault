...
async function main() {
  ...
  console.log("LiquidityVault Address:", vaultContract.address);
  ...
  const totalClaimCounts = 6             //6회
  const startTime = 1642752000            //2022년 1월 21일 금요일 오후 5:00:00
  ...
  const firstClaimAmount = 3000000  //3,000,000
