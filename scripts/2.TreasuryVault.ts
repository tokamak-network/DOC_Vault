...
async function main() {
  ...
  console.log("TreasuryVault Address:", vaultContract.address);
  console.log("setting start");

  const BASE_TEN = 10
  const decimals = 18

  const totalAllocatedAmount = 24750000   //24,750,000
  ...
  //전송 후 DOC 토큰 전송 필요
  //npx hardhat verify --contract contracts/TreasuryVault.sol:TreasuryVault a b --network rinkeby
}
