...
describe("MarketingVault_AURA", () => {
    ...
    let totalClaim = 17
    let monthlyReward = claimAllAmount/(totalClaim-1)
    ...
    before(async () => {
        ...
        const TreasuryVault = await ethers.getContractFactory("MarketingVault");
    ...
    describe("MarketingVault_AURA Test", () => {
        describe("setting", () => {
            it("check name, doc ", async function() {
                expect(await stakerVault.name()).to.equal("Marketing");
        ...
        describe("claim", () =>{
            ...
            it("claim after 5month", async () => {    
                ...
                expect(Number(tx)).to.equal(Number(monthlyReward*6));
            })

            it("claim after 16month", async () => {    
